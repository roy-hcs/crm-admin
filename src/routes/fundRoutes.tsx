...
/**
 * Fund Management routes - corresponds to "资金管理" menu item
 *
 * Routes:
 * - /fund/wallet-adjustment  - 钱包余额调整 (Wallet Balance Adjustment)
 * - /fund/account-adjustment - 账号余额调整 (Account Balance Adjustment)
 */
