...
export const DepositRebateInfoCard: FC<{
  ...
  const accountInfo = useMemo(() => {
    return [
      ...
      {
        label: 'table.depositAmount',
        value: `${Info.commissionBase && Info.currency ? Info.commissionBase + Info.currency : '-'}`,
      },
      {
        label: 'table.rebateRatio',
