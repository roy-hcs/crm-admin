...
import { useCloseOrder } from '@/api/hooks/ticket/ticket';
...
export const CloseOrderDialog = ({
  ...
  return (
    <RrhDialog
      title={t('ticketList.closeTicket')}
      ...
      <FormProvider form={form}>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="grid gap-y-6">
            ...
            <div className="text-muted-foreground text-sm">{t('ticketList.closeOrder')}</div>
